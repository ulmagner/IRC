...
#    Updated: 2025/07/22 12:48:30 by ulmagner         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		= ircserv
SRCS		= main.cpp Serv.cpp ACmd.cpp PassCmd.cpp Client.cpp NickCmd.cpp UserCmd.cpp JoinCmd.cpp Channel.cpp
INCS		= Serv.hpp ACmd.hpp PassCmd.hpp Client.hpp NickCmd.hpp UserCmd.hpp JoinCmd.hpp Channel.hpp
