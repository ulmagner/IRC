...
#    Updated: 2025/07/30 13:55:58 by ulmagner         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		= ircserv
SRCS		= main.cpp Serv.cpp ACmd.cpp PassCmd.cpp Client.cpp NickCmd.cpp UserCmd.cpp \
JoinCmd.cpp Channel.cpp KickCmd.cpp InviteCmd.cpp TopicCmd.cpp PartCmd.cpp
INCS		= Serv.hpp ACmd.hpp PassCmd.hpp Client.hpp NickCmd.hpp UserCmd.hpp \
JoinCmd.hpp Channel.hpp KickCmd.hpp InviteCmd.hpp TopicCmd.hpp PartCmd.hpp
